...
export default function Terms() {
  return (
    <DocShell title="Terms of Service" lastUpdated={LAST_UPDATED}>
      <p>
        These Terms apply to the EchoExpense app (&ldquo;Application&rdquo;) for mobile devices created by
      ...
      <div>
        ...
        <p>
          You may not copy, modify, reverse engineer, translate, extract source code from, or create
          derivative works of the Application. All trademarks, copyrights, database rights, and other
          intellectual property rights remain the property of the Service Provider.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          The Service Provider may modify the Application or charge for services at any time. Any applicable
          charges will be clearly communicated in advance where required.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          The Application stores and processes personal data you provide to deliver the Service. You are
          responsible for maintaining the security of your device and access to the Application. Jailbreaking
          or rooting your device may compromise security and cause the Application to malfunction; such use is
      ...
      <div>
        ...
        <p>
          Some functions require an active internet connection. The Service Provider is not responsible for lack
          of Wi-Fi/data or related charges (including roaming). If you are not the bill payer for your device,
      ...
      <div>
        ...
        <p>
          You are responsible for ensuring your device remains charged and functional. While the Service Provider
          strives to keep the Application accurate and up-to-date, it relies on third-party data and is not liable
          for losses resulting from reliance on the Application’s functionality or content.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          You agree to accept updates when offered. The Service Provider may stop providing the Application and
          terminate its use at any time. Upon termination, your rights under these Terms end and you must cease
          use and, if necessary, delete the Application from your device.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          These Terms may be updated periodically. Updates will be posted on this page and/or in-app. Continued
