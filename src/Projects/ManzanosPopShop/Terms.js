...
const Terms = () => {
  return (
    <div style={{ padding: "20px", maxWidth: "800px", margin: "auto" }}>
      ...
      <p>
        These terms and conditions apply to the Manzanos PopShop app ("Application") for mobile devices that was created by devzano ("Service Provider") as an Ad Supported service.
      </p>
      ...
      <h2>Contact Me</h2>
      <p>
        If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at rmanzano.se@gmail.com.
      </p>
    </div>
  );
};
