...
const Terms = () => {
  return (
    <div style={{ padding: "20px", maxWidth: "800px", margin: "auto" }}>
      ...
      <p>
        These terms and conditions apply to the EchoExpense app ("Application") for mobile devices that was created by devzano ("Service Provider") as an Ad Supported service.
      </p>
