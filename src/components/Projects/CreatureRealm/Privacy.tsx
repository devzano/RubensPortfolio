// src/components/Projects/CreatureRealm/Privacy.tsx
"use client";
...
export default function Privacy() {
  return (
    <DocShell title="Privacy Policy" lastUpdated={LAST_UPDATED}>
      <p>
        This Privacy Policy applies to the CreatureRealm mobile application (&ldquo;Application&rdquo;)
        created by devzano (&ldquo;Service Provider&rdquo;) as an ad-supported service. The
        Application is provided for use &ldquo;AS IS.&rdquo;
      </p>
      ...
      <div>
        ...
        <ul className="list-disc space-y-2 pl-6 marker:text-sky-400">
          ...
          <li>Pages you visit within the Application and the time/date of each visit</li>
        ...
        <p className="mt-3">
          ...
          information. Any information you provide is retained and used as described in this Policy.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          Application and related services. The Application also uses third-party services with their
