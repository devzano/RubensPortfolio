// src/components/Projects/Logiqo/Terms.tsx
"use client";
...
export default function Terms() {
  return (
    <DocShell title="Terms of Service" lastUpdated={LAST_UPDATED}>
      <p>
        These Terms apply to the Logiqo app (&ldquo;Application&rdquo;) for mobile devices created by
        devzano (&ldquo;Service Provider&rdquo;) as an ad-supported service. By downloading or using
      ...
      <div>
        ...
        <p>
          ...
          applicable charges will be clearly communicated in advance where required.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          The Application stores and processes personal data you provide to deliver the Service. You
          are responsible for maintaining the security of your device and access to the Application.
          Jailbreaking or rooting your device may compromise security and cause the Application to
          malfunction; such use is discouraged and at your own risk.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          and is not liable for losses resulting from reliance on the Application’s functionality or content.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          You agree to accept updates when offered. The Service Provider may stop providing the Application
          and terminate its use at any time. Upon termination, your rights under these Terms end and you
          must cease use and, if necessary, delete the Application from your device.
        </p>
      </div>
